...
public class SRSWindow : MonoBehaviour
{
    ...
    void updateSrsData()
    {
        ...
        srsData.recieving = radio.isReceiving;
    ...
    void OnGUI()
    {
        ...
        try
        {
            windowRect = GUILayout.Window(
                ...
                "SRS",
                windowStyle,
                GUILayout.MinWidth(Plugin.width)
            );
        }
    ...
    private void DrawWindow(int id)
    {
        ...
        GUILayout.Box(GUIContent.none,
            srsData.transmitting ? greenBoxStyle : (srsData.recieving ? blueBoxStyle : redBoxStyle),
